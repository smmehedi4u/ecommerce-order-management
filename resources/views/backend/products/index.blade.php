...
<x-app-layout>
    <x-slot name="header">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            <h2 style="font-weight: 600; font-size: 1.25rem; color: #1f2937; line-height: 1.5;">All Products</h2>
                    ...
                    <tbody>
                        @foreach ($products as $product)
                            <tr style="border-bottom: 1px solid #ddd;">
                                ...
                                <td style="padding: 10px; border: 1px solid #ccc;">${{ number_format($product->price, 2) }}</td>
                                <td style="padding: 10px; border: 1px solid #ccc;">{{ $product->stock_quantity }}</td>
                                <td style="padding: 10px; border: 1px solid #ccc;">
                                    <a href="{{ route('products.edit', $product) }}"
                                    style="margin-right: 10px; background-color: #05bd2d; color: #ffffff; padding: 5px 10px; border-radius: 4px; cursor: pointer; text-decoration: none;">
                                        Edit
                                    </a>
